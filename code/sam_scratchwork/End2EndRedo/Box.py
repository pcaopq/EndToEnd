...
class Box:
    def __init__(self, *args, geometry_settings):
    ...
    def windmill(self):
        ...
        return tuple(Box(D, self.geometry_settings) for D in (D0,D1,D2,D3)) #TODO: can we express above more elegantly?
