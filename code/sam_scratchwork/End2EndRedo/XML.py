...
get0 = lambda *tags: lambda xml_element: xml_element if not tags else \
           get0(tags[1:])(xml_element).getElementsByTagName[0](tag)
...
class XML:
	...
	def getTextblocks(self):
		...
		xmldoc = minidom.parse(self.xml_name)
		printspace = get0('alto','Layout','Page','PrintSpace')(xmldoc)
